...
public class TotalStatisticsByCompanyDto {
    ...
    public TotalStatisticsByCompanyDto() {
    }
    public TotalStatisticsByCompanyDto(String companyName, Long residualCount, Long activityCount) {
